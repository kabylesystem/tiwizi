...
const DEFS = [
  ...
  {
    id: "q-achal", order: 40, family: "interrogation",
    name: "acḥal · combien ?",
    schema: "acḥal (…) ?",
    frHint: /combien/i,
    detect: re(wb("acḥal|cḥal")),
    mask: re(wb("acḥal|cḥal"), "giu"),
    corrupt: [],
    contrastsWith: ["q-acu"],
    requires: [],
    foilFrom: "q-acu", foilAnswer: 1,
    note: "« acḥal » = combien : Acḥal ṭṭseɣ ? = combien de temps ai-je dormi ? Acḥal atig-is ? = combien ça coûte ? Le mot du marché.",
    probe: { q: "On demande…", options: ["une quantité (combien)", "une chose (quoi)"], answer: 0 },
  },
  {
    id: "comp-axir", order: 41, family: "comparaison",
    name: "axir · mieux",
    schema: "… axir (n …)",
    frHint: /(mieux|meilleur|préfér|plutôt|vaut)/i,
    detect: re(wb("axir")),
    mask: re(wb("axir"), "giu"),
    corrupt: [],
    contrastsWith: [],
    requires: [],
    foilFrom: null, foilAnswer: 1,
    note: "« axir » = mieux, préférable : Akka axir = c'est mieux ainsi, Anwa axir ? = lequel est le mieux ? Pour comparer sans conjuguer quoi que ce soit.",
    probe: { q: "La phrase dit que c'est…", options: ["mieux / préférable", "pareil / égal"], answer: 0 },
  },
  {
    id: "imperatif", order: 42, family: "l'ordre",
    name: "l'impératif · la racine nue",
    schema: "VERBE(-clitique) !",
    frHint: /^(va|viens|prends|donne|laisse|mange|bois|attends|arrête|regarde|écoute|dis|fais|mets|ouvre|ferme|revien|rentre|entre|sors|assieds|lève|apporte|montre|aide|répond|essaie|oublie|réveille|tais|dépêche|allez|allons|reste|pars|tiens|garde|appelle|excuse|pardonne|souviens|calme)/i,
    frMust: /^(va|viens|prends|donne|laisse|mange|bois|attends|arrête|regarde|écoute|dis|fais|mets|ouvre|ferme|revien|rentre|entre|sors|assieds|lève|apporte|montre|aide|répond|essaie|oublie|réveille|tais|dépêche|allez|allons|reste|pars|tiens|garde|appelle|excuse|pardonne|souviens|calme)/i,
    detect: re("^\\p{Lu}\\p{L}{1,}(?:-\\p{L}+)*\\s*[^.?]*!"),
    exclude: re("^(Tom|Mary|Ur|Ad|Ma\\b|Anda|Acu|Amek|Melmi|Anwa|Ansi|Iwacu|Ayɣer|Acḥal|D\\s|Yya)", "iu"),
    mask: re("^\\p{L}+(?:-\\p{L}+)?", "u"),
    corrupt: [],
    contrastsWith: ["fut-ad"],
    requires: [],
    foilFrom: "fut-ad", foilAnswer: 1,
    note: "L'ordre, c'est le verbe TOUT NU, sans aucune marque : Ruḥ ! = va !, Ečč ! = mange !, Bed ! = lève-toi ! C'est la forme de base du verbe, celle du dictionnaire. Au pluriel : -et (Ruḥet ! = allez !).",
    probe: { q: "Cette phrase…", options: ["donne un ORDRE (fais-le !)", "annonce une action à venir"], answer: 0 },
  },
];
